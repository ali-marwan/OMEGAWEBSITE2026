...
export function DiagnosisHero() {
  return (
    <section
      id="top"
      className="relative isolate overflow-hidden bg-warmwhite pt-28 pb-12 md:pt-32 md:pb-16"
    >
      ...
      <div className="relative mx-auto max-w-page px-6 lg:px-10">
        ...
        <div className="mt-6 max-w-3xl space-y-4 text-base md:text-lg leading-[1.7] text-muted">
          <p>
            Describe the issue, upload photos, and get guided toward
            the right OMEGA path.
          </p>
          {"\n"}
          <p>
            Diagnose issues. Understand solutions. Take the right
            action — guided by OMEGA's experience servicing properties
            across the UAE.
          </p>
        </div>
